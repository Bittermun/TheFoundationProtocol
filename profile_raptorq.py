...
def main():
    ...
    for size_bytes, size_label in test_sizes:
        ...
        for redundancy in redundancies:
            ...
            try:
                ...
                print(
                    f"{result['elapsed_ms']:.1f}ms ({result['throughput_mbps']:.2f} MB/s, {result['shard_count']} shards)"
                )
    ...
    print("=" * 70)
    print(
        f"{'Size':<10} {'Redundancy':<12} {'Time (ms)':<12} {'Throughput (MB/s)':<20} {'Shards':<10}"
    )
    print("-" * 70)
    ...
    for r in results:
        ...
        print(
            f"{size_label:<10} {r['redundancy'] * 100:>10.0f}% {r['elapsed_ms']:>10.1f} {r['throughput_mbps']:>18.2f} {r['shard_count']:>10}"
        )
