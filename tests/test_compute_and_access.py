...
from tfp_core.compute.task_mesh import (
    ComputeMesh, TaskRecipe, DeviceBid, ScheduledTask, generate_task_id
)
from tfp_core.compute.verify_habp import (
    HABPVerifier, ExecutionProof, ConsensusResult, generate_execution_proof
)
from tfp_core.compute.device_safety import (
    DeviceSafetyGuard, DeviceMetrics, SafetyStatus, create_device_metrics
)
from tfp_core.compute.credit_formula import (
    CreditFormula, CreditCalculation, calculate_task_credits
)
from tfp_plugins.access_control.license_manager import (
    LicenseManager, LicenseType, create_time_locked_content,
    create_paywalled_content, create_community_content
)
from tfp_plugins.access_control.threshold_release import (
    ThresholdReleaser, create_multi_sig_release
)
...
class TestCreditFormula(unittest.TestCase):
    ...
    def test_charging_bonus(self):
        ...
        self.assertGreater(result_charging.final_credits, result_no_charge.final_credits)
