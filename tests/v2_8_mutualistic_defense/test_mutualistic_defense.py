...
class TestContentTag(unittest.TestCase):
    ...
    def test_tag_creation(self):
        tag = ContentTag(content_hash="abc123", tag_type="malware", confidence=0.9)
    ...
    def test_needs_refresh(self):
        tag = ContentTag(content_hash="abc123", tag_type="suspicious", confidence=0.8)
    ...
    def test_attestation_addition(self):
        tag = ContentTag(content_hash="abc123", tag_type="malware", confidence=0.7)
...
class TestGossipVerifier(unittest.TestCase):
    ...
    def test_signal_broadcast(self):
        ...
        signal = gossip.broadcast_trust_signal(
            auditor_id="auditor_x", outcome=True, category="video"
        )
...
class TestMutualisticAuditor(unittest.TestCase):
    ...
    def test_cooldown_instead_of_slashing(self):
        ...
        for _ in range(5):
            self.auditor.report_audit_outcome(
                auditor_id="bad_auditor", was_correct=False, category="video"
            )
    ...
    def test_tag_decay_cleanup(self):
        ...
        self.auditor.active_tags["old_tag"] = ContentTag(
            content_hash="old_tag", tag_type="suspicious", confidence=0.4
        )
        # Age it
    ...
    def test_false_positive_recovery(self):
        ...
        for _ in range(5):
            auditor.report_audit_outcome(
                auditor_id="mistaken_auditor", was_correct=False, category="video"
            )
        ...
        for _ in range(10):
            auditor.report_audit_outcome(
                auditor_id="mistaken_auditor", was_correct=True, category="video"
            )
