...
class TestTaskMeshGates(unittest.TestCase):
    ...
    def test_device_registration(self):
        ...
        success = self.gates.register_device("device_A", HardwareCapability.CPU_BASIC, 50.0)
    ...
    def test_device_registration_insufficient_stake(self):
        ...
        success = self.gates.register_device("device_B", HardwareCapability.CPU_BASIC, 5.0)
    ...
    def test_consensus_achievement(self):
        ...
        # Register devices
        for i, cap in enumerate([HardwareCapability.CPU_BASIC, HardwareCapability.TEE_SECURE, 
    ...
    def test_consensus_mismatch(self):
        ...
        # Register devices
        for i in range(3):
            self.gates.register_device(f"mismatch_device_{i}", HardwareCapability.CPU_BASIC, 50.0)
    ...
    def test_stake_decay(self):
        ...
        self.assertGreater(decayed_balance, initial_balance * 0.9)  # Should still have >90%
    ...
    def test_economic_stats(self):
        ...
        self.gates.register_device("stat_device_2", HardwareCapability.TEE_SECURE, 200.0)
