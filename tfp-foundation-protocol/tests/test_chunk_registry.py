...
class TestChunkRegistry:
    ...
    def test_get_chunks_by_category(self):
        ...
        registry.register(chunk_data=b"texture1", category="texture", chunk_id_hint="t1")
        registry.register(chunk_data=b"texture2", category="texture", chunk_id_hint="t2")
    ...
    def test_serialization_roundtrip(self):
        ...
        original.register(chunk_data=b"data2", category="audio_pattern", chunk_id_hint="d2")
        original.register(chunk_data=b"data3", category="code_block", chunk_id_hint="d3")
    ...
    def test_concurrent_registration_thread_safe(self):
        ...
        threads = [threading.Thread(target=register_chunk, args=(i,)) for i in range(10)]
        for t in threads:
            t.start()
        for t in threads:
            t.join()
