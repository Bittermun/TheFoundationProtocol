...
class TestChunkStore:
    ...
    def test_lru_eviction_by_bytes(self):
        ...
        store.put(chunk_data=b"c" * 40, category="texture", chunk_id_hint="big3")  # Should trigger eviction
    ...
    def test_update_existing_chunk(self):
        ...
        chunk_id = store.put(chunk_data=b"version1", category="texture", chunk_id_hint="updatable")
    ...
    def test_rare_chunk_credit_reward(self):
        ...
        common_id = store.put(chunk_data=b"common", category="texture", chunk_id_hint="common")
        for _ in range(100):
            store.get(common_id)
        
        # Rare chunk (accessed once)
        rare_id = store.put(chunk_data=b"rare", category="texture", chunk_id_hint="rare")
        store.get(rare_id)
    ...
    def test_access_count_tracking(self):
        ...
        chunk_id = store.put(chunk_data=b"tracked", category="texture", chunk_id_hint="tracked")
    ...
    def test_eviction_callback(self):
        ...
        store.put(chunk_data=b"chunk1", category="texture", chunk_id_hint="c1")
        store.put(chunk_data=b"chunk2", category="texture", chunk_id_hint="c2")
        store.put(chunk_data=b"chunk3", category="texture", chunk_id_hint="c3")  # Triggers eviction
