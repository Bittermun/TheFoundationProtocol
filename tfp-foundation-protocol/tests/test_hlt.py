...
from tfp_client.lib.lexicon.hlt.tree import HierarchicalLexiconTree, LexiconNode, NodeType
from tfp_client.lib.lexicon.hlt.delta import LexiconDelta, DeltaType
...
class TestHierarchicalLexiconTree:
    ...
    def test_add_adapter_to_domain(self):
        ...
        hlt = HierarchicalLexiconTree()
        domain_id = hlt.add_domain("medical", "v2.1.0", hashlib.sha3_256(b"med").hexdigest())
    ...
    def test_get_path_from_root(self):
        ...
        hlt = HierarchicalLexiconTree()
        domain_id = hlt.add_domain("legal", "v1.0.0", hashlib.sha3_256(b"legal").hexdigest())
    ...
    def test_get_latest_version(self):
        ...
        hlt = HierarchicalLexiconTree()
        domain_id = hlt.add_domain("science", "v1.0.0", hashlib.sha3_256(b"sci").hexdigest())
    ...
    def test_tree_serialization(self):
        ...
        hlt = HierarchicalLexiconTree()
        domain_id = hlt.add_domain("art", "v1.0.0", hashlib.sha3_256(b"art").hexdigest())
...
class TestLexiconSynchronizer:
    ...
    def test_process_sync_response(self):
        ...
        local_hlt = HierarchicalLexiconTree()
        domain_id = local_hlt.add_domain("legal", "v1.0.0", hashlib.sha3_256(b"leg").hexdigest())
    ...
    def test_detect_semantic_drift(self):
        ...
        local_hlt = HierarchicalLexiconTree()
        local_hlt.add_domain("science", "v1.0.0", hashlib.sha3_256(b"sci_local").hexdigest())
...
class TestHLTIntegration:
    ...
    def test_hlt_validates_chunk_recipe(self):
        ...
        hlt = HierarchicalLexiconTree()
        domain_id = hlt.add_domain("news_layout", "v4.0.0", hashlib.sha3_256(b"news").hexdigest())
    ...
    def test_hlt_with_tag_index_discovery(self):
        ...
        hlt = HierarchicalLexiconTree()
        hlt.add_domain("medical", "v2.1.0", hashlib.sha3_256(b"med").hexdigest(), tags=["healthcare"])
        hlt.add_domain("legal", "v1.0.0", hashlib.sha3_256(b"leg").hexdigest(), tags=["law"])
        
        # Query by tag
        medical_domains = [n for n in hlt.nodes.values() 
