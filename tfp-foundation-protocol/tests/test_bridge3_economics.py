...
from tfp_client.lib.credit.dwcc_calculator import DWCCCalculator, SemanticValueTier, DWCCEntry
from tfp_client.lib.credit.hybrid_wallet import HybridWallet, WalletBalance
from tfp_client.lib.storage.pinning_manager import PinningManager, PinnedContent
...
class TestDWCCCalculator:
    ...
    def test_calculate_dwcc_decay(self):
        ...
        old_time = datetime.now(timezone.utc).timestamp() + 100  # Far future = high decay
...
class TestPinningManager:
    ...
    def test_pin_exceeds_quota(self):
        ...
        assert stats["total_pinned_bytes"] <= 1500  # Allow some tolerance for eviction logic
