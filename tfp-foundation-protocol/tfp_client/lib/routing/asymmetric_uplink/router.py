...
class AsymmetricUplinkRouter:
    def __init__(self, w_latency: float = 0.4, w_energy: float = 0.3, w_drop: float = 0.3):
    ...
    def choose_uplink_channel(self, channels: List[ChannelMetrics], proof_bytes: bytes = None) -> int:
        if not channels:
