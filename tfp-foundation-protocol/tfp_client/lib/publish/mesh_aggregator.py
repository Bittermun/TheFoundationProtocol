...
class MeshAggregator:
    ...
    def receive_announcement(self, hash_hex: str, metadata: Dict[str, Any], 
        ...
        if source_node and source_node not in self._announcements[hash_hex]["source_nodes"]:
    ...
    def aggregate_demand_signals(self, time_window: float = 3600.0) -> Dict[str, Dict[str, Any]]:
        """
        ...
        for hash_hex, count in self._demand_counts.items():
            ...
            aggregated[hash_hex] = {
                ...
                "source_node_count": len(self._announcements.get(hash_hex, {}).get("source_nodes", []))
            }
        
        self._last_aggregated = current_time
        return aggregated
    
    def get_top_demand(self, limit: int = 10, 
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        avg_demand = total_demand / len(self._demand_counts) if self._demand_counts else 0.0
