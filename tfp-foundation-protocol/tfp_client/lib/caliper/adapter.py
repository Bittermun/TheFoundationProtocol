...
class CaliperAdapter:
    ...
    DEFAULT_MIN_ENCODE_THROUGHPUT = 100_000   # 100 KB/s (conservative)
    ...
    def benchmark_encode_decode(self, payload_size: int = 4096) -> BenchmarkResult:
        ...
        try:
            ...
            return self._unavailable_result("raptorq_encode_decode", "RealRaptorQAdapter unavailable")
    ...
    def benchmark_credit_ops(self) -> BenchmarkResult:
        ...
        try:
            ...
            return self._unavailable_result("credit_ledger_ops", "CreditLedger unavailable")
    ...
    def benchmark_end_to_end(self, payload_size: int = 512) -> BenchmarkResult:
        ...
        try:
            ...
            return self._unavailable_result("end_to_end_latency", "TFPClient unavailable")
