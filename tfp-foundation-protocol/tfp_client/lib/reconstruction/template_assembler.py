...
class AssemblyResult:
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            "content_hash": self.content_hash,
            "assembled_data": self.assembled_data.hex() if self.assembled_data else None,
    ...
    def from_dict(cls, data: Dict) -> "AssemblyResult":
        ...
        return cls(
            ...
            content_hash=data["content_hash"],
            assembled_data=bytes.fromhex(data["assembled_data"]) if data.get("assembled_data") else None,
...
class TemplateAssembler:
    ...
    def assemble(self, recipe: Recipe) -> AssemblyResult:
        ...
        compute_saved = (len(cached_chunks) / len(recipe.chunk_ids)) * 100 if recipe.chunk_ids else 0
    ...
    def get_assembly_plan(self, recipe: Recipe) -> Dict[str, Any]:
        ...
        return {
            ...
            "hlt_synced": hlt_synced,
            "cache_hit_rate": len(cached) / len(recipe.chunk_ids) if recipe.chunk_ids else 0,
