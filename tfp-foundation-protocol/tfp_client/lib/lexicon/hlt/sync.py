...
class LexiconSynchronizer:
    ...
    def start_sync(self, remote_merkle_root: str) -> Dict:
        ...
        self._log_sync_event("sync_started", {
            "remote_merkle_root": remote_merkle_root[:16] + "..."
        })
    ...
    def get_sync_status(self) -> Dict:
        ...
        return {
            ...
            "remote_merkle_root": self._remote_merkle_root[:16] + "..." if self._remote_merkle_root else None,
