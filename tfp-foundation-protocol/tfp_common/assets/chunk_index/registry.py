...
from .categories import CHUNK_CATEGORIES, validate_category, get_category_by_name
            ...
            if chunk_id_hint:
                ...
                if chunk_id_hint in self._chunks:
                    if allow_update:
                        ...
                        if old_hash in self._hash_to_id and self._hash_to_id[old_hash] == chunk_id_hint:
                        ...
                        raise ValueError(f"Chunk ID '{chunk_id_hint}' already exists. Use allow_update=True to update.")
