...
class ProtocolAdapter:
    ...
    async def browse_content(self, category: Optional[str] = None) -> List[UIContentItem]:
        """
...
class MockProtocolAdapter(ProtocolAdapter):
    ...
    async def record_and_share(self, media_type: str, media_data: bytes, title: str, category: str) -> int:
        if self.on_share_complete:
