...
class WebBridge:
        ...
        if parsed.netloc or (parsed.path and not parsed.path.startswith('/tag/')):
            ...
            if len(potential_hash) == 64 and all(c in '0123456789abcdef' for c in potential_hash.lower()):
                ...
                if '.' in potential_hash:
                    ...
                    request.content_type = self.content_type_registry.get(ext, TFPContentType.UNKNOWN)
                else:
    ...
    def register_content_type(self, extension: str, content_type: TFPContentType) -> None:
        """
