...
def verify_content_signature(
    ...
    sig = Signature(
        ...
        classical_signature=bytes.fromhex(signature_data["classical_signature"]) if signature_data.get("classical_signature") else None
    )
