...
class HABPVerifier:
    ...
    def verify_consensus(self, task_id: str) -> Optional[ConsensusResult]:
        ...
        if len(largest_group) >= self._consensus_threshold:
            ...
            credit_weight = confidence * (1.0 + (len(largest_group) - self._consensus_threshold) * 0.1)
    ...
    def verify_tee(self, proof: ExecutionProof, expected_output_hash: str) -> Optional[ConsensusResult]:
        """
