...
class CreditFormula:
    ...
    def calculate_credits(
        ...
        hardware_multiplier = self._clamp(
            hardware_trust,
            self._min_hardware_trust,
            self._max_hardware_trust
        )
        ...
        uptime_factor = self._clamp(
            uptime_factor,
            self._min_uptime_factor,
            self._max_uptime_factor
        )
        ...
        return CreditCalculation(
            ...
            breakdown={
                ...
                "total_multiplier": round(
                    hardware_multiplier * uptime_factor * verif_factor * charging_bonus * speed_bonus,
                    3
                )
            }
        )
